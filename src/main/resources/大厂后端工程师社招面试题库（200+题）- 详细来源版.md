...
53. **线程的生命周期？**[(参考链接)](https://www.baeldung.com/java-thread-lifecycle)
   ...
   💡 **配套代码演示**：[ThreadLifecycleDemo.java](../java/com/example/interview/demo/ThreadLifecycleDemo.java) - 完整演示线程6种状态的转换过程
...
55. **线程池的拒绝策略？**[(参考链接)](https://www.baeldung.com/java-threadpool-rejection-strategies)
   ...
   💡 **配套代码演示**：[ThreadPoolRejectionStrategiesDemo.java](../java/com/example/interview/demo/ThreadPoolRejectionStrategiesDemo.java) - 完整演示4种拒绝策略的实际效果
